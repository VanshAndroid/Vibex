...
public class OtpView extends AppCompatEditText {
  ...
  public OtpView(Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, com.d.R.attr.otpViewStyle);
  }
  ...
  public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray typedArray =
        theme.obtainStyledAttributes(attrs, com.d.R.styleable.OtpView, defStyleAttr, 0);
    viewType = typedArray.getInt(com.d.R.styleable.OtpView_viewType, VIEW_TYPE_RECTANGLE);
    otpViewItemCount = typedArray.getInt(com.d.R.styleable.OtpView_itemCount, DEFAULT_COUNT);
    otpViewItemHeight = (int) typedArray.getDimension(com.d.R.styleable.OtpView_itemHeight,
        res.getDimensionPixelSize(com.d.R.dimen.otp_view_item_size));
    otpViewItemWidth = (int) typedArray.getDimension(com.d.R.styleable.OtpView_itemWidth,
        res.getDimensionPixelSize(com.d.R.dimen.otp_view_item_size));
    otpViewItemSpacing = typedArray.getDimensionPixelSize(com.d.R.styleable.OtpView_itemSpacing,
        res.getDimensionPixelSize(com.d.R.dimen.otp_view_item_spacing));
    otpViewItemRadius = (int) typedArray.getDimension(com.d.R.styleable.OtpView_itemRadius, 0);
    lineWidth = (int) typedArray.getDimension(com.d.R.styleable.OtpView_lineWidth,
        res.getDimensionPixelSize(com.d.R.dimen.otp_view_item_line_width));
    lineColor = typedArray.getColorStateList(com.d.R.styleable.OtpView_lineColor);
    isCursorVisible = typedArray.getBoolean(com.d.R.styleable.OtpView_android_cursorVisible, true);
    cursorColor = typedArray.getColor(com.d.R.styleable.OtpView_cursorColor, getCurrentTextColor());
    cursorWidth = typedArray.getDimensionPixelSize(com.d.R.styleable.OtpView_cursorWidth,
        res.getDimensionPixelSize(com.d.R.dimen.otp_view_cursor_width));
    itemBackground = typedArray.getDrawable(com.d.R.styleable.OtpView_android_itemBackground);
    hideLineWhenFilled = typedArray.getBoolean(com.d.R.styleable.OtpView_hideLineWhenFilled, false);
    typedArray.recycle();
    if (lineColor != null) {
